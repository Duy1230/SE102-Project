...
#define ID_SPRITE_MARIO_FOX_ATTACK (ID_SPRITE_MARIO_FOX_HOLD + 800)
#define ID_SPRITE_MARIO_FOX_ATTACK_FRONT (ID_SPRITE_MARIO_FOX_HOLD + 1)
#define ID_SPRITE_MARIO_FOX_ATTACK_BACK (ID_SPRITE_MARIO_FOX_HOLD + 2)
#pragma endregion 
